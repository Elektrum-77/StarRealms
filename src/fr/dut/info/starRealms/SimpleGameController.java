...
public class SimpleGameController {
	...
	static GameBoard initGameBoard() 
	{
		...
		// M�langer tous chaque deck des joueurs
		gameBoard.shuffleAllPlayersDeck();

		// M�langer le deck du jeu
		gameBoard.getTradeDeck().shuffle();

		// On initialise le premier joueur en le d�signant al�atoirement
		...
		// Tout le monde pioche 5 carte sauf le joueur qui commence pioche 3 cartes (voir r�gles)
	...
	static void simpleGame(ApplicationContext context)
	{
		...
		// Nouveau background defini al�atoirement
	...
	public static GameBoard concreteCards(GameBoard gameBoard) {
		...
		// Cr�ation d'un primary avec action sp�ciale
		Primary embassyYachtPrimary = new Primary(0,2,3,0);
		embassyYachtPrimary.addSpecialAction(new SpeActEmbassyYacht()); // ajout d'une action sp�ciale au primary
